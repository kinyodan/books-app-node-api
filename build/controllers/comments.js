...
const connectDb = (data, read, write, destination) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (read) {
            dbconnection.getConnection(function (err, connection) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    let param_data = data;
                    let sql = "SELECT * FROM comments WHERE book_isbn=" +
                        `'${param_data.isbn}'` +
...
const connectDbWrite = (data, read, write, destination) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (write) {
            connectionWrite.getConnection(function (err, connection) {
                ...
                let sql_write = "INSERT INTO comments (comment, commenter_ip_adress, book_isbn) VALUES (" +
                    `'${param_data.comment}'` +
                    "," +
            ...
            connectionWrite.getConnection(function (err, connection) {
                ...
                let param_data = JSON.parse(data);
                let sql_read = "SELECT * FROM comments WHERE book_isbn=" +
                    `'${param_data.isbn}'` +
                    " ORDER BY created_at DESC";
